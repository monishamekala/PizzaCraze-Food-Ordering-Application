  ...
  return (
    <div className= "my-3 about">
        ...
        <div className='my-3 aboutBottom'>
            ...
            <Link to={'/about/teamlead'}><button type="button" class="btn btn-dark">Team Lead</button></Link>
        <Link to={'/about/frontendlead'}>
        <button type="button" class="btn btn-dark">Frontend Lead</button></Link>
        <Link to={'/about/backendlead'}>
        <button type="button" class="btn btn-dark">Backend Lead</button></Link>
        ...
        <button type="button" class="btn btn-dark">Github Master</button></Link>
        <Link to={'/about/scrummaster'}>
        <button type="button" class="btn btn-dark">Scrum Master</button></Link>
            </div>
